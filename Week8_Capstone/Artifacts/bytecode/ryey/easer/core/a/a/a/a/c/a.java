public class ryey.easer.core.a.a.a.a.c.a implements ryey.easer.core.a.a.a.g {
  public ryey.easer.core.a.a.a.a.c.a(android.content.Context);
    Code:
       0: aload_0
  ...
  public java.util.List<java.lang.String> a();
    Code:
      ...
      34: checkcast     #46                 // class ryey/easer/core/a/g
      37: invokevirtual #71                 // Method ryey/easer/core/a/g.a:()Ljava/lang/String;
  ...
  public void a(ryey.easer.core.a.f);
    Code:
       0: aload_0
       1: aload_1
       2: checkcast     #46                 // class ryey/easer/core/a/g
       5: invokevirtual #81                 // Method a:(Lryey/easer/core/a/g;)V
       8: return

  public void a(ryey.easer.core.a.g);
    Code:
      ...
      12: aload_3
      13: aload_1
      14: invokevirtual #71                 // Method ryey/easer/core/a/g.a:()Ljava/lang/String;
      17: invokevirtual #88                 // Method java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
      20: pop
      21: aload_3
      22: ldc           #90                 // String .json
      24: invokevirtual #88                 // Method java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
      27: pop
      28: new           #92                 // class java/io/File
      31: dup
      32: aload_2
      33: aload_3
      34: invokevirtual #95                 // Method java/lang/StringBuilder.toString:()Ljava/lang/String;
      37: invokespecial #98                 // Method java/io/File."<init>":(Ljava/io/File;Ljava/lang/String;)V
      40: astore_2
      41: new           #100                // class ryey/easer/core/a/a/a/a/c/c
      44: dup
      45: invokespecial #101                // Method ryey/easer/core/a/a/a/a/c/c."<init>":()V
      48: aload_2
      49: aload_1
      50: invokestatic  #104                // Method ryey/easer/core/a/a/a/d.a:(Lryey/easer/core/a/a/a/i;Ljava/io/File;Ljava/lang/Object;)V
      53: return
  ...
  public boolean a(java.lang.String);
    Code:
      ...
      12: aload_3
      13: aload_1
      14: invokevirtual #88                 // Method java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
      17: pop
      18: aload_3
      19: ldc           #90                 // String .json
      21: invokevirtual #88                 // Method java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
      24: pop
      25: aload_2
      26: aload_3
      27: invokevirtual #95                 // Method java/lang/StringBuilder.toString:()Ljava/lang/String;
      30: invokestatic  #108                // Method ryey/easer/core/a/a/a/e.b:(Ljava/io/File;Ljava/lang/String;)Z
      33: ireturn

  public java.util.List<ryey.easer.core.a.g> b();
    Code:
       0: new           #49                 // class java/util/ArrayList
       3: dup
       4: invokespecial #50                 // Method java/util/ArrayList."<init>":()V
      ...
      11: new           #8                  // class ryey/easer/core/a/a/a/a/c/a$1
      14: dup
      15: aload_0
      16: invokespecial #115                // Method ryey/easer/core/a/a/a/a/c/a$1."<init>":(Lryey/easer/core/a/a/a/a/c/a;)V
      ...
      42: aload_0
      43: aload         5
      45: invokespecial #121                // Method a:(Ljava/io/File;)Lryey/easer/core/a/g;
  ...
  public ryey.easer.core.a.f b(java.lang.String);
    Code:
       0: aload_0
       1: aload_1
       2: invokevirtual #141                // Method d:(Ljava/lang/String;)Lryey/easer/core/a/g;
       5: areturn
  ...
  public void c(java.lang.String);
    Code:
      ...
      21: invokevirtual #88                 // Method java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
      24: pop
      25: new           #92                 // class java/io/File
      28: dup
      29: aload_2
      30: aload_3
      31: invokevirtual #95                 // Method java/lang/StringBuilder.toString:()Ljava/lang/String;
      34: invokespecial #98                 // Method java/io/File."<init>":(Ljava/io/File;Ljava/lang/String;)V
      37: astore_1
      38: aload_1
      39: invokevirtual #146                // Method java/io/File.delete:()Z
      42: ifne          78
      45: new           #83                 // class java/lang/StringBuilder
      48: dup
      49: invokespecial #84                 // Method java/lang/StringBuilder."<init>":()V
      52: astore_2
      53: aload_2
      ...
      69: dup
      70: aload_2
      71: invokevirtual #95                 // Method java/lang/StringBuilder.toString:()Ljava/lang/String;
      74: invokespecial #153                // Method java/lang/IllegalStateException."<init>":(Ljava/lang/String;)V
      77: athrow
      78: return

  public ryey.easer.core.a.g d(java.lang.String);
    Code:
       0: getstatic     #34                 // Field b:Ljava/io/File;
       3: astore_2
       4: new           #83                 // class java/lang/StringBuilder
      ...
      24: pop
      25: aload_0
      26: new           #92                 // class java/io/File
      29: dup
      30: aload_2
      31: aload_3
      32: invokevirtual #95                 // Method java/lang/StringBuilder.toString:()Ljava/lang/String;
      35: invokespecial #98                 // Method java/io/File."<init>":(Ljava/io/File;Ljava/lang/String;)V
      38: invokespecial #121                // Method a:(Ljava/io/File;)Lryey/easer/core/a/g;
      41: areturn
}
