public class ryey.easer.core.ui.data.event.b<T extends ryey.easer.commons.local_plugin.eventplugin.EventData> extends ryey.easer.core.ui.data.h<T> {
  public ryey.easer.core.ui.data.event.b();
    Code:
       0: aload_0
       1: invokespecial #9                  // Method ryey/easer/core/ui/data/h."<init>":()V
       4: return

  static <T extends ryey.easer.commons.local_plugin.eventplugin.EventData> ryey.easer.core.ui.data.event.b<T> a(ryey.easer.commons.local_plugin.eventplugin.b<T>);
    Code:
      ...
      11: aload_0
      12: invokeinterface #22,  1           // InterfaceMethod ryey/easer/commons/local_plugin/eventplugin/b.a:()Ljava/lang/String;
      17: invokevirtual #26                 // Method android/os/Bundle.putString:(Ljava/lang/String;Ljava/lang/String;)V
      20: new           #2                  // class ryey/easer/core/ui/data/event/b
      23: dup
  ...
  public ryey.easer.commons.local_plugin.f a();
    Code:
       0: aload_0
       1: invokevirtual #46                 // Method b:()Lryey/easer/commons/local_plugin/eventplugin/EventData;
       4: areturn
  ...
  public T b();
    Code:
       ...
       4: checkcast     #50                 // class ryey/easer/commons/local_plugin/eventplugin/EventData
       7: areturn
  ...
  public void onCreate(android.os.Bundle);
    Code:
      ...
      19: invokevirtual #70                 // Method ryey/easer/plugins/b.b:()Lryey/easer/plugins/b$c;
      22: aload_1
      23: invokevirtual #75                 // Method ryey/easer/plugins/b$c.b:(Ljava/lang/String;)Lryey/easer/commons/local_plugin/d;
      26: checkcast     #19                 // class ryey/easer/commons/local_plugin/eventplugin/b
      29: invokeinterface #79,  1           // InterfaceMethod ryey/easer/commons/local_plugin/eventplugin/b.d:()Lryey/easer/commons/local_plugin/e;
  ...
  public void onStart();
    Code:
       ...
       7: invokevirtual #70                 // Method ryey/easer/plugins/b.b:()Lryey/easer/plugins/b$c;
      10: aload_0
      ...
      17: checkcast     #19                 // class ryey/easer/commons/local_plugin/eventplugin/b
      20: astore_1
      21: aload_1
      22: aload_0
      23: invokevirtual #121                // Method getContext:()Landroid/content/Context;
      26: invokeinterface #124,  2          // InterfaceMethod ryey/easer/commons/local_plugin/eventplugin/b.b:(Landroid/content/Context;)Z
      31: ifne          50
      34: aload_0
      35: iconst_0
      ...
      44: iconst_1
      45: invokeinterface #131,  3          // InterfaceMethod ryey/easer/commons/local_plugin/eventplugin/b.a:(Landroid/app/Activity;I)V
      50: return
}
