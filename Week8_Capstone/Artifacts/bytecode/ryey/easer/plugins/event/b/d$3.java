class ryey.easer.plugins.event.b.d$3 implements android.view.View$OnClickListener {
  final ryey.easer.plugins.event.b.d a;

  ryey.easer.plugins.event.b.d$3(ryey.easer.plugins.event.b.d);
    Code:
       0: aload_0
       1: aload_1
       2: putfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
       5: aload_0
  ...
  public void onClick(android.view.View);
    Code:
       0: aload_0
       1: getfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
       4: invokevirtual #31                 // Method ryey/easer/plugins/event/b/d.getContext:()Landroid/content/Context;
      ...
      15: return
      16: aload_0
      17: getfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
      20: invokevirtual #31                 // Method ryey/easer/plugins/event/b/d.getContext:()Landroid/content/Context;
      23: aload_0
      24: getfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
      27: invokestatic  #41                 // Method ryey/easer/plugins/event/b/d.a:(Lryey/easer/plugins/event/b/d;)Landroid/content/BroadcastReceiver;
      30: aload_0
      31: getfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
      34: invokestatic  #45                 // Method ryey/easer/plugins/event/b/d.c:(Lryey/easer/plugins/event/b/d;)Landroid/content/IntentFilter;
      ...
      44: dup
      45: aload_0
      46: getfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
      49: invokevirtual #31                 // Method ryey/easer/plugins/event/b/d.getContext:()Landroid/content/Context;
      ...
      66: dup
      67: aload_0
      68: getfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
      71: invokevirtual #31                 // Method ryey/easer/plugins/event/b/d.getContext:()Landroid/content/Context;
     ...
     116: astore        4
     118: aload_2
     119: new           #97                 // class ryey/easer/plugins/event/b/d$a
     122: dup
     123: aload_0
     124: getfield      #21                 // Field a:Lryey/easer/plugins/event/b/d;
     127: aload         4
     129: invokespecial #100                // Method ryey/easer/plugins/event/b/d$a."<init>":(Lryey/easer/plugins/event/b/d;Landroid/bluetooth/BluetoothDevice;)V
     132: invokevirtual #104                // Method android/widget/ArrayAdapter.add:(Ljava/lang/Object;)V
     135: goto          98
     138: aload_1
     139: ldc           #105                // int 2131623988
     141: new           #13                 // class ryey/easer/plugins/event/b/d$3$1
     144: dup
     145: aload_0
     146: invokespecial #108                // Method ryey/easer/plugins/event/b/d$3$1."<init>":(Lryey/easer/plugins/event/b/d$3;)V
     ...
     153: aload_1
     154: aload_2
     155: new           #15                 // class ryey/easer/plugins/event/b/d$3$2
     158: dup
     159: aload_0
     160: aload_2
     161: invokespecial #115                // Method ryey/easer/plugins/event/b/d$3$2."<init>":(Lryey/easer/plugins/event/b/d$3;Landroid/widget/ArrayAdapter;)V
