class ryey.easer.plugins.operation.q.e$1 implements android.widget.CompoundButton$OnCheckedChangeListener {
  final ryey.easer.plugins.operation.q.e a;

  ryey.easer.plugins.operation.q.e$1(ryey.easer.plugins.operation.q.e);
    Code:
       0: aload_0
       1: aload_1
  ...
  public void onCheckedChanged(android.widget.CompoundButton, boolean);
    Code:
       ...
       4: getfield      #27                 // Field ryey/easer/plugins/operation/q/e.f:Landroid/widget/SeekBar;
       7: astore_1
       8: iload_2
       9: ifeq          17
      12: iconst_0
