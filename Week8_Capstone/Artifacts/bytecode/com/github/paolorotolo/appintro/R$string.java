public final class com.github.paolorotolo.appintro.R$string {
  ...
  public static final int app_intro_done_button;

  public static final int app_intro_skip_button;

  public static final int define_appintro;

  public static final int library_appintro_author;

  public static final int library_appintro_authorWebsite;

  public static final int library_appintro_classPath;

  public static final int library_appintro_isOpenSource;

  public static final int library_appintro_libraryDescription;

  public static final int library_appintro_libraryName;

  public static final int library_appintro_libraryVersion;

  public static final int library_appintro_libraryWebsite;

  public static final int library_appintro_licenseId;

  public static final int library_appintro_repositoryLink;

  public static final int search_menu_title;

  public static final int status_bar_notification_info_overflow;

  public com.github.paolorotolo.appintro.R$string();
    Code:
       0: aload_0
